...
if __name__ == '__main__':
    ...
    paser.add_argument("-p", "--prefix", default="dog", choices=["processed", "test_dog", "dog", "fireworks", "baby", "drum", "gun", "sneeze", "cough", "hammer"])
    ...
    if args.prefix in ["test_dog", "dog", "fireworks", "baby", "drum"]:
        n_test = 0
    else:
        n_test = 0
