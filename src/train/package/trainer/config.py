...
_C.training_files = _C.BASE_DATA_PATH + 'features/filelists/playing_bongo_train.txt'
_C.test_files = _C.BASE_DATA_PATH + 'features/filelists/playing_bongo_test.txt'
