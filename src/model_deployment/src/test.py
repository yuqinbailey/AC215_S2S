...
if __name__ == '__main__':
    ...
    if not os.path.exists("/workspace/ckpt/"):
        os.makedirs("/workspace/ckpt/bongo/")
        os.makedirs("/workspace/ckpt/drum_wavenet/")
    ...
    blob.download_to_filename(f"/workspace/ckpt/bongo/checkpoint_latest_netG")
    blob = bucket.blob(f"ckpt/bongo/checkpoint_latest_netD")
    blob.download_to_filename(f"/workspace/ckpt/bongo/checkpoint_latest_netD")

    # wavenet
    blob = bucket.blob(f"ckpt/drum_wavenet/drum_checkpoint_step000160000_ema.pth")
    blob.download_to_filename(f"/workspace/ckpt/drum_wavenet/drum_checkpoint_step000160000_ema.pth")
