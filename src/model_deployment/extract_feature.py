...
class TSNDataSet(Dataset):
    def __init__(self, root_path, video_list, modality='RGB', image_tmpl='img_{:05d}.jpg', transform=None):
...
if __name__ == '__main__':    
    ...
    group.add_argument('-t', '--test_list', type=str)
    group.add_argument('-f', '--test_name', type=str)
    ...
    data_loader = torch.utils.data.DataLoader(
            TSNDataSet(args.input_dir, video_list,
